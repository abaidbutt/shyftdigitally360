  ...
  return (
    <>
      <Box>
        ...
        >
          <Box>
            <Link href="/crm/contacts/add" passHref>
        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="right">Last History</StyledTableCell>
              <StyledTableCell align="right">Assigned To</StyledTableCell>
              <StyledTableCell align="right">Contact Type</StyledTableCell>
              <StyledTableCell align="right">Contact Status</StyledTableCell>
