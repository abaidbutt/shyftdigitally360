          ...
          */}
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={2} sm={2} md={2} lg={2}>
              ...
              <Input namer="quality" control={control} />
            </Grid>
            <Grid item xs={2} sm={2} md={2} lg={2}>
              <Typography>Price</Typography>

              <Input namer="price" control={control} />
            </Grid>
          ...
          <Grid container>
            ...
            <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
              ...
              <Button sx={{ p: 1.7, mx: 1 }} variant="outlined" type="submit">
                Save
              </Button>
